...
fun RemoteWebDriver.sendFleet(sin: String, target: Position, fleet: Fleet) {
    get("http://uni9.ogam.net.pl/index.php?page=fleet&from=rs&mode=raport&galaxy=${target.galaxy}&system=${target.system}&planet=${target.planet}&planettype=1&target_mission=1")
